                    ...
                    <section class="profile-form">
                        ...
                        <div class="profile">
                            <div class="profile-img">
                                ...
                                <!-- Delete Account button (opens SweetAlert) -->
                                <form id="deleteAccountForm" action="controller/delete-account.php" method="POST" style="margin-top: 0.5rem;">
                                    <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token); ?>">
                                    <button type="button" class="btn-dark change" id="btnDeleteAccount" style="background-color:#dc3545;border-color:#dc3545;">
                            ...
                            <div id="Edit">
                                <form action="controller/profile-controller.php?id=<?php echo $user_id ?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                    <div class="row gx-5 needs-validation">
                                        ...
                                        <label class="form-label" style="text-align: left; padding-top: .5rem; padding-bottom: 1rem; font-size: 1rem; font-weight: bold;"><i class='bx bxs-edit'></i> Edit Profile
                                            <p>Last update: <?php echo $user_last_update ?></p>
                                        </label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" value="<?php echo $user_birth_date ?>" autocapitalize="off" autocomplete="off" name="date_of_birth" id="date_of_birth" maxlength="10" placeholder="Ex: mm/dd/yyyy" onkeyup="getAgeVal(0)" onblur="getAgeVal(0);">
                                            <div class="invalid-feedback">
                            ...
                            <div id="avatar" style="display: none;">
                                <form action="controller/profile-controller.php?id=<?php echo $user_id ?>" method="POST" enctype="multipart/form-data" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                    <div class="row gx-5 needs-validation">
                                        ...
                                        <label class="form-label" style="text-align: left; padding-top: .5rem; padding-bottom: 1rem; font-size: 1rem; font-weight: bold;"><i class='bx bxs-user'></i> Change Avatar
                                            <p>Last update: <?php echo $user_last_update ?></p>
                                        </label>
                            ...
                            <div id="password" style="display: none;">
                                <form action="controller/profile-controller.php?id=<?php echo $user_id ?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                    <div class="row gx-5 needs-validation">
                                        ...
                                        <label class="form-label" style="text-align: left; padding-top: .5rem; padding-bottom: 1rem; font-size: 1rem; font-weight: bold;"><i class='bx bxs-key'></i> Change Password
                                            <p>Last update: <?php echo $user_last_update ?></p>
                                        </label>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnDelete.addEventListener('click', function () {
            swal({
                ...
                text: "All your account information will be permanently deleted and cannot be recovered.",
                icon: "warning",
